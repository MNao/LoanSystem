<%@ Page Language="C#" MasterPageFile="~/MasterMain.master" AutoEventWireup="true" CodeFile="ViewClientDetails.aspx.cs" Inherits="ViewClientDetails" Title="VIEW Clients" %>
    ...
    <asp:View ID="SearchView" runat="server">
        ...
        <div class="row">
            <div class="col-lg-3">
                ...
                <asp:TextBox ID="txtSearch" runat="server" ClientIdMode="Static" CssClass="form-control" placeholder="Search"></asp:TextBox>
            </div>
            <div class="col-lg-2">
                <label>
                    Status
                        ...
                        <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Details">
                                    <ItemTemplate>
                                        <i style="color:dodgerblue;"><a class="fa fa-thumbs-o-up"><asp:Button runat="server" ID="btnApprove" Text="Approve" ForeColor="dodgerblue" CommandName="Approve" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" BackColor="WhiteSmoke" BorderStyle="None"></asp:Button></a></i>
                                        
                                        <%--<asp:Button ID="btnApprove" runat="server" Text="View Details" CommandName="Approve" CommandArgument="<%# ((GridViewRow) Container).RowIndex %>" />--%>
                                    </ItemTemplate>
                                </asp:TemplateField>
