        ...
        <!---------------------------------------------- Search Options --------------------------------->
            <asp:MultiView ID="MultiView2" ActiveViewIndex="0" runat="server">
                ...
                <asp:GridView runat="server" Width="100%" CssClass="table table-bordered table-hover"
                            ID="dataGridResults"> <%--OnRowCommand="dataGridResults_RowCommand" OnRowCreated="dataGridResults_RowCreated" 115E9B--%>
                            <AlternatingRowStyle BackColor="#BFE4FF" />
                            <HeaderStyle BackColor="#FF2F33" Font-Bold="false" ForeColor="white" Font-Italic="False"
